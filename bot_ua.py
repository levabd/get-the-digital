...
TELE_TOKEN='1695238100:AAG-yFIQBuc7Hj-EMq1D3z8abzBnHM7g8ww'

def send_email(phone, first_name, last_name, chat_id):
    # if (chat_id == 571417480):145868031
    phone_button = "Мій номер"
    token = TELE_TOKEN
    URL = "https://api.telegram.org/bot{}/".format(token)
    final_text = "Дякую. Ми скоро з вами зв'яжемося."
...
def send_message(reply, chat_id, text):
    ...
    URL = "https://api.telegram.org/bot{}/".format(token)
    if (text == "/start"):
        final_text = "Вітаємо! Будь-ласка, авторизуйте Ваш номер і ми зв'яжемося з Вами найближчим часом."
    else:
        final_text = "Авторизуйте Ваш номер і ми зв'яжемося з Вами найближчим часом."
